...
drawhand(current_time.second * 6, radius * .95, radius // 10, "red")
...
while True:
    ...
    if current_time.second is not new_time.second:
        turtle.title(new_time.strftime("%H:%M Analog Clock"))
        drawhand(current_time.second * 6, radius * .95, radius // 10, "red")
        drawhand(current_time.minute * 6, radius * .8, radius // 10, "lightgray")
        drawhand((new_time.second * 6), radius * .95, radius //10, "red")
